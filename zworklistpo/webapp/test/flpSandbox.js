		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "work list po",
									"targetURL": "#pozworklistpo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pozworklistpo-display": {
								"semanticObject": "pozworklistpo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=po.zworklistpo",
									"url": sap.ui.require.toUrl("po/zworklistpo")
								}
							}
						}
					}
