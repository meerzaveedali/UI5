		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "bussiness partner details",
									"targetURL": "#bpbussinesspartner-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bpbussinesspartner-display": {
								"semanticObject": "bpbussinesspartner",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bp.bussinesspartner",
									"url": sap.ui.require.toUrl("bp/bussinesspartner")
								}
							}
						}
					}
